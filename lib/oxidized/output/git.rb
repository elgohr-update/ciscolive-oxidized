...
module Oxidized
  class Git < Output
    ...
    def setup
      if @cfg.empty?
        Oxidized.asetus.user.output.git.user  = "Netstack"
        Oxidized.asetus.user.output.git.email = "968826@gmail.com"
        Oxidized.asetus.user.output.git.repo  = File.join(Config::ROOT, "netstack.git")
